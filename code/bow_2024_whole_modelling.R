# ---------------------------------------------------------------------------------------------
#' Analysis file for the bow whales data
...
rawRes <- read_csv("NE Atlantic Data/Bowhead_whale.csv") 


resGrid <- read_csv("NE Atlantic Data/RES spreadsheets/Bowhead whale (Balaena mysticetus) - Native range.csv")
