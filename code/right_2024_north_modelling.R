# ---------------------------------------------------------------------------------------------
#' Analysis file for the right whales data
#' 2024 - NE atlantic analyses
#'  - Location: whole and north are teh same
#' 
...
rawRes <- read_csv("NE Atlantic Data/North_Atlantic_right_whale.csv") %>%
   filter(str_detect(Location, "North"))


resGrid <- read_csv("NE Atlantic Data/RES spreadsheets/North Atantic right whale (Eubalaena glacialis) - Suitable habitat.csv")
