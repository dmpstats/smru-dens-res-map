...
#' 
  ...
  ggsave("docs/images/sperm_Atlantic_bootplot_100.png", units = "cm", width = 30, height = 20)
...
# Create RES grid predictions -----------------------------------------------------------------
  ...
  write.csv(predictionOutput, file = "data/sperm_Atlantic_predictions.csv", row.names = F)
