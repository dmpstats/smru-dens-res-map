# ---------------------------------------------------------------------------------------------
#' Analysis file for the minke data
...
# Preamble ------------------------------------------------------------------------------------
  ...
  rawRes <- read_csv("NE Atlantic Data/Minke_whale.csv")
  
  
  resGrid <- read_csv("NE Atlantic Data/RES spreadsheets/Common minke whale (Balaenoptera acutorostrata) - Native range.csv")
